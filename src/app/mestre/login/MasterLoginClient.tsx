...
export function MasterLoginClient({ systemConfig }: MasterLoginClientProps) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#020617] p-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md bg-[#0a0f1c]/80 backdrop-blur-xl border border-white/5 rounded-3xl p-8 sm:p-10 shadow-2xl relative overflow-hidden group hover:border-white/10 transition-all duration-500">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-slate-400 font-bold uppercase tracking-wider">Acesso de Administrador SaaS</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-xs font-bold text-slate-400 mb-2 uppercase tracking-wider">E-mail do Administrador</label>
            ...
            {!recoveryResult ? (
              <>
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-xl font-bold text-white mb-2">Recuperar Conta Mestre</h3>
              ...
              <>
                ...
                <div className="bg-[#040814] border border-white/5 rounded-2xl p-5 mb-6 text-left font-sans">
                  ...
                  <div className="space-y-3 text-xs text-slate-350">
                    ...
                    <p className="text-[10px] text-slate-550 italic mt-4">Nota: Recomendamos que você altere esta senha após o login por questões de segurança.</p>
                  </div>
                </div>
